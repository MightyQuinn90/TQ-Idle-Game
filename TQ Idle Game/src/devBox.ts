...
function handleTick(args: string[]) {
...
function handleSetActivity(args: string[]){
  const skill = args[1] as SkillId
  if(!skill){
...
function handleCraft(args: string[]) {
