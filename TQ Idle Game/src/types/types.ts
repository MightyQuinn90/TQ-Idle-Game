...
export type ItemTypes = 
    'fish' | 'log' | 'ore' | 'bar' | 'crafting' | 'arrow' | 'material' | 'currency'
...
export type SkillId = "woodcutting" | 'mining' | 'smithing' | 'crafting' | 'fishing' | 'health' | 'attack' | 'defense'
...
export type ItemId = 
    ...
    'stone_block' | 'gold_bar' | 'gold_coin' | 'silver_coin' | 'copper_coin'
