...
export const items: Record<ItemId, Item> = {
  ...
  wooden_chest: {
    ...
    lootTableId: "wooden_chest_loot",
  },
  splintered_club: {
    name: "Splintered Club",
    type: "weapon",
    description: "A heavy branch from a nearby tree. It’s sticky.",
    attackPower: 2,
    speedBonus: 0,
    xp: 0,
    value: 50,
  ...
  steel_schmitar: {
    name: "Steel Scimitar",
    type: "weapon",
    description: "Lightweight and expertly balanced.",
    attackPower: 22,
    speedBonus: 5,
    xp: 0,
    value: 75,
  ...
  rust_shortsword: {
    ...
    type: "weapon",
    description: "More rust than metal, but it gets the job done.",
    attackPower: 5,
    speedBonus: 1,
    xp: 0,
    value: 10,
  ...
  iron_broadsword: {
    ...
    type: "weapon",
    description: "A solid, reliable blade. Standard issue for guards.",
    attackPower: 12,
    speedBonus: -2,
    xp: 0,
    value: 30,
  ...
  spite_blade: {
    name: "The Spite Blade",
    type: "weapon",
    description:
      "Forged during a frantic week-long sprint. It hums with caffeine.",
    attackPower: 45,
    speedBonus: 10,
    xp: 0,
    value: 100,
