...
import type { Item, CraftingRecipe, ItemId, SkillId } from "../types/types.js"
...
export const items: Record<ItemId, Item> = {
    ...
    gold_coin: {name: 'Gold', value: 1, xp: 0, type: 'currency', stackable: false, levelReq: 1},
    silver_coin: {name: 'Silver', value: 1, xp: 0, type: 'currency', stackable: false, levelReq: 1}, 
    copper_coin: {name: 'Copper', value: 1, xp: 0, type: 'currency', stackable: false, levelReq: 1}
} 
//AHAHAHAHAH I have to figure out seperating Combat skills like attack and health from these gatherSources. 
//this says Attack and health are missing
export const gatherSources: Record<SkillId, ItemId[]> = {
    woodcutting: [
    ...
    attack: [],//cant stay here
    defense: [],//cant stay here
    health: []//cant stay here 
}
