...
export function playerGoesFirst(player, monster) {
    return player.speed >= monster.speed;
}
export function handleCombatXp(player, damageDealt) {
...
export function performAttack(player, monster) {
...
export function processCombatTicks(player, combatState) {
    if (!combatState.targetMonster || !combatState.isInCombat)
        return;
...
export function handleRespawn(player, monsterId) {
...
export function handleMonsterDeath(player, combatState) {
    const monster = combatState.targetMonster;
    if (!monster)
        return;
    combatState.combatLog.push(`${monster.name} died`);
...
export function startCombatLoop(player, monsterId) {
...
export function equipWeapon(player, weaponId) {
...
//# sourceMappingURL=combatSystems.js.map